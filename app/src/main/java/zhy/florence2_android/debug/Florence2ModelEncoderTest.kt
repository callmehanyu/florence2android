...
//        addXnnpack(po)
    ...
    private val _sessionEncoder_part1_section1: OrtSession = R.raw.encoder_model_part1_section1.createByteSession()
    private val _sessionEncoder_part1_section2: OrtSession = R.raw.encoder_model_part1_section2.createByteSession()

    private val _sessionEncoder_part1_section2_unit1: OrtSession = R.raw.encoder_model_part1_section2_unit1.createByteSession()
    private val _sessionEncoder_part1_section2_unit2: OrtSession = R.raw.encoder_model_part1_section2_unit2.createByteSession()

    private val _sessionEncoder_part1_section2_unit1_block1: OrtSession = R.raw.encoder_model_part1_section2_unit1_block1.createByteSession()
    private val _sessionEncoder_part1_section2_unit1_block2: OrtSession = R.raw.encoder_model_part1_section2_unit1_block2.createByteSession()
    private val _sessionEncoder_part1_section2_unit1_block3: OrtSession = R.raw.encoder_model_part1_section2_unit1_block3.createByteSession()
    ...
    private val _sessionEncoder_part2_section2_unit2_block1: OrtSession = R.raw.encoder_model_part2_section2_unit2_block1.createByteSession()
    private val _sessionEncoder_part2_section2_unit2_block2: OrtSession = R.raw.encoder_model_part2_section2_unit2_block2.createByteSession()
    private val _sessionEncoder_part2_section2_unit2_block3: OrtSession = R.raw.encoder_model_part2_section2_unit2_block3.createByteSession()
    ...
    fun run(attention_mask: OnnxTensor, inputs_embeds: OnnxTensor, ): OrtSession.Result? {
        ...
        val _sessionEncoder_part1_section2_unit1_block1_result = _sessionEncoder_part1_section2_unit1_block1.run(
            mapOf(
                "attention_mask" to attention_mask,
            ),
        ...
        val _sessionEncoder_part1_section2_unit1_block2_result = _sessionEncoder_part1_section2_unit1_block2.run(
            mapOf(
        ...
        val _sessionEncoder_part1_section2_unit1_block3_result = _sessionEncoder_part1_section2_unit1_block3.run(
            mapOf(
...
//        val _sessionEncoder_part1_result = OnnxTensor.createTensor(OrtEnvironment.getEnvironment(), array)
        ...
        val _sessionEncoder_part2_section2_unit2_block1_result = _sessionEncoder_part2_section2_unit2_block1.run(
            mapOf(
                "/Where_1_output_0" to _sessionEncoder_part1_result["/Where_1_output_0"].get() as OnnxTensor,
        ...
        val _sessionEncoder_part2_section2_unit2_block2_result = _sessionEncoder_part2_section2_unit2_block2.run(
            mapOf(
        ...
        val _sessionEncoder_part2_section2_unit2_block3_result = _sessionEncoder_part2_section2_unit2_block3.run(
            mapOf(
